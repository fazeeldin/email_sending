...
server = smtplib.SMTP(host='smtp-mail.outlook.com', port=587) # to use any other host, check for their host name and its respective port number from internet
server.ehlo()
server.starttls()
server.ehlo()
server.login("email id", "password")#Give your id and pwd here
text = msg.as_string()
